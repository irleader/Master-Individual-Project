...
# <experiment 3>Use the above function to read Hap.py output VCF (from both Illumina and Pacbio reads)
# p1,count1,wgs_variants,len_6_format_row_wgs=read_happy_vcf("../../../raw_Data/SNP_INDEL/illumina.happy.SNP_INDEL_chr20.vcf")
# p2,count2,pacbio_variants,len_6_format_row_pacbio=read_happy_vcf("../../../raw_Data/SNP_INDEL/p30.happy.SNP_INDEL_chr20.vcf")


# <experiment 2> Use the above function to read Hap.py output VCF (from both Illumina and Pacbio reads)
p1,count1,wgs_variants,len_6_format_row_wgs=read_happy_vcf("../../../raw_Data/SNP/illumina.happy.vcf")
p2,count2,pacbio_variants,len_6_format_row_pacbio=read_happy_vcf("../../../raw_Data/SNP/pacbio.happy.vcf")
...
with open("wgs.simulate.csv","w") as file:
...
with open("pacbio.simulate.csv","w") as file:
    writer=csv.writer(file)
    writer.writerow(['chrom','pos','ref','alt','info','t_genotype','t_decision','t_decision_sub','t_quality','t_additional_info','t_variant_type','t_location_type',
                  'q_genotype','q_decision','q_decision_sub','q_quality','q_additional_info','q_variant_type','q_location_type'])
...
with open("truth.simulate.csv","r") as file:
...
with open("cleaned_truth.simulate.csv","w") as file:
    writer=csv.writer(file)
